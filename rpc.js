...
class SlyvexInterface {
    ...
    async main() {
        ...
        const methods = proto.SlyvexdMessage.type.field
        ...
        program
            ...
            .description(`Slyvex gRPC client ${pkg.version}`)
...
Please run ${'slyvex-rpc help'.yellow} for addition information and examples.        
        `)
        ...
        program
            ...
            .action(async (cmd, options) => {
                ...
                console.log('');
                console.log(`Slyvex gRPC client ${pkg.version}`);
                console.log('');
...
Examples:
    ...
    $ ${`rpc --verbose getUtxosByAddresses --addresses=[\\"slyvextest:qru9nrs0mjcrfnl7rpxhhe33l3sxzgrc3ypkvkx57u\\"]`.yellow}
    ...
    Where file.js can contain: ${`{ addresses : ['slyvextest:qru9nrs0mjcrfnl7rpxhhe33l3sxzgrc3ypkvkx57u'] }`.yellow}
